...
class Classifier:
    ...
    def train(self, train_path, valid_path):
        ...
        call_backs = [
            ...
            TensorBoard(log_dir='/content/drive/MyDrive/xongxoa/Emotion-ResNet50/Graph', histogram_freq=0,
                        write_graph=True, write_images=True)
        ]
        self.model.fit(train_generator, validation_data=valid_generator, epochs=200,
                       callbacks=[call_backs, tensorboard])
